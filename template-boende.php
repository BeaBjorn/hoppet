...
<?php get_header(); ?>
        ...
        <img class="indexImg" alt="black and white inage of horse" src="<?= get_template_directory_uri(); ?>/images/boende.jpg">
        </div>
        ...
        <?php
        /* This php-block uses query_posts to only display posts from the category "info-boende" 
        ...
        /* This php-block uses query_posts to only display posts from the category "boende" 
            and is set to display one post only.  */       
            query_posts('category_name=boende');
